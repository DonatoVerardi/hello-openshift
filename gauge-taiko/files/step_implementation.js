...
step("Open cam application", async function () {
    await goto("https://www.valiant.​ch/cam");
});


step("Enter <arg0> in <arg1>", async function(arg0, arg1) {
    await write(arg0, into(textBox(arg1)));
});
...
step("Must have the text <arg0>", async function(arg0) {
